...
Run:  python models/generate_necks.py
      python models/generate_necks.py --width 160 --repeats 3
"""
...
def build(kind, width, repeats):
    ...
    out = [
        f"# {back} + {neck} + CBAM",
        "#",
        "# GENERATED by models/generate_necks.py -- do not edit by hand.",
...
def main():
    ...
    for kind in ("resnet34-fpn-cbam", "resnet34-bifpn-cbam", "yolo11s-bifpn-cbam"):
        (HERE / f"{kind}.yaml").write_text(build(kind, args.width, args.repeats),
                                           encoding="utf-8")
